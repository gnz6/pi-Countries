...
export default function Home() {
    ...
    const handleClick = (e) => {
        ...
        setCurrentPage(0)
        document.getElementsByClassName("sb")[0].value = ""
        document.getElementById("popOrder").value = ""
        document.getElementById("abcOrder").value = ""
        document.getElementById("activitySelect").value = "all"
            ...
            <div className='homeNav'>
                <div className='titleContainer'>
                    ...
                    <div className='sbContainer'>
                        <input className='sb' onChange={handleSearch} placeholder="Search Countries..." name='searchBar' />
                        <button className='sbButton' onClick={emptySb}>X</button>
                    </div>
                </div>
                <div className='allBarsContainer'>
                    ...
                    <div className='arrows'>
                        <button className='navPagingButton' onClick={prevPage} > ← </button>
                        <button className='numButton'>{parseInt(currentPage === 0 ? 0 : currentPage.toString().length === 2 ? currentPage.toString()[0] : currentPage.toString()[0] + currentPage.toString()[1]) + 1}</button>
                    ...
                    <div className='orderFilter'>
                        ...
                        <div className='orderContainer'>
                            ...
                            <label >
                                <h3>Order By</h3>
                                <select className="homeSelect" id='abcOrder' name='order' defaultValue={""} onChange={handleOrderABC}>
                            ...
                            <label >
                                <select className="homeSelect" id='popOrder' name='population' defaultValue={""} onChange={handleOrderPopulation}>
                        ...
                        <div className='filterContainer'>
                            <label >
                                <h3>Filter By</h3>
                                <select className="homeSelect" id='filterSelect' name='continent' defaultValue={"all"} onChange={handleContinentChange}>
                            ...
                            <label>
                                <select className="homeSelect" id='activitySelect' name='activities' defaultValue={"all"} onChange={handleActivityChange}>
                                                        ...
                                                        c.population.toString().length === 9 ? `${c.population.toString()[0]}${c.population.toString()[1]}${c.population.toString()[2]}.${c.population.toString()[3]} Million` :
                                                            c.population.toString().length === 8 ? `${c.population.toString()[0]}${c.population.toString()[1]}.${c.population.toString()[2]} Million` :
                                                                c.population.toString().length === 7 ? `${c.population.toString()[0]}.${c.population.toString()[1]} Million` :
                                                                    c.population.toString().length === 6 ? `${c.population.toString()[0]}${c.population.toString()[1]}${c.population.toString()[2]}.${c.population.toString()[3]}${c.population.toString()[4]}${c.population.toString()[5]} ` :
                                                                        c.population.toString().length === 5 ? `${c.population.toString()[0]}${c.population.toString()[1]}.${c.population.toString()[2]}${c.population.toString()[3]}${c.population.toString()[4]} ` :
                                                                            c.population.toString().length === 4 ? `${c.population.toString()[0]}.${c.population.toString()[1]}${c.population.toString()[2]}${c.population.toString()[3]} ` :
                                                                                c.population.toString().length === 3 ? `${c.population} ` :
                                                                                    c.population.toString().length < 3 ? `${c.population} ` :
                                                                                        c.population : 0
